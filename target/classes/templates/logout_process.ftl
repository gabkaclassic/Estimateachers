...
<html lang = "en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/static/star_style.css">
    </head>
    ...
    <body>
        <div class="container mt-10 overflow-hidden">
            <div class="row mt-5 w-50 mx-auto">
                ...
                <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalLabel">Sign out</h5>
                            </div>
                            <div class="modal-body">
                                <p>Are you sure you want to get out?</p>
                            </div>
                            <div class="modal-footer">
                                <form action = "/users/signout/cancel" method = "post">
