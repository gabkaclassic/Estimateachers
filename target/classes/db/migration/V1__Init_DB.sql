...
create table creating_card_applications (id int8 generated by default as identity, card_id int8 not null, date timestamp, viewed boolean not null, card_title varchar(255), card_type varchar(255) not null, student_id int8, primary key (id));
