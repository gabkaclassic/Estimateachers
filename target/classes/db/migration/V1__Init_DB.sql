...
alter table if exists creating_card_applications add constraint creating_card_applications_students_fk foreign key (student_id) references students;
alter table if exists registration_applications add constraint registration_applications_students_fk foreign key (student_id) references students;
