...
create table dormitories (id int8 generated by default as identity, title varchar(255) not null, card_type varchar(255) not null default 'DORMITORY', approved boolean default 'f', capacity_rating float8 default 0.0, cleaning_rating float8 default 0.0, roommates_rating float8 default 0.0, primary key (id));
...
create table faculties (id int8 generated by default as identity, title varchar(255) not null, card_type varchar(255) not null default 'FACULTY', approved boolean default 'f', education_rating float8 default 0.0, price_rating float8 default 0.0, primary key (id));
...
create table teachers (id int8 generated by default as identity, approved boolean default 'f', title varchar(255) not null, card_type varchar(255) not null default 'TEACHER', exacting_rating float8 default 0.0, first_name varchar(255) not null, freebies_rating float8 default 0.0, last_name varchar(255) not null, patronymic varchar(255) not null, severity_rating float8 default 0.0, primary key (id));
...
create table universities (id int8 generated by default as identity, title varchar(255) not null, approved boolean default 'f', card_type varchar(255) not null default 'UNIVERSITY', abbreviation varchar(255), bachelor boolean, magistracy boolean, specialty boolean, primary key (id));
