...
create table teachers (id int8 generated by default as identity, title varchar(255) not null, email varchar(255), exacting_rating float8, first_name varchar(255) not null, freebies_rating float8, last_name varchar(255) not null, patronymic varchar(255) not null, severity_rating float8, primary key (id));
